package com.example.agrehahora

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import androidx.recyclerview.widget.LinearLayoutManager
import androidx.recyclerview.widget.RecyclerView
import com.example.agrehahora.adapter.AdapterProduto
import com.example.agrehahora.model.Produto
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val produto1 = Produto(
            R.drawable.ssd,"SSD SanDisk Plus 480GB",
        ...
        val produto2 = Produto(
            R.drawable.processador,"Intel Core i5 10400F",
        ...
        val produto3 = Produto(
            R.drawable.placadevideo,"GeForce RTX 3090 24GB",
        ...
        val produto4 = Produto(
            R.drawable.memoria,"Memória Ram Corsair  8GB DDR4",
            "Memória Corsair Vengeance LPX, 8GB, 2666MHz, DDR4, C16, Preto.",
            "R$ 369,00"
        )
        listaProdutos.add(produto4)
        val produto5 = Produto(
            R.drawable.teclado,"Teclado Mecânico Gamer T-Dagger Corvette",
        ...
        val produto6 = Produto(
            R.drawable.gabinete,"Gabinete Gamer",
